...
namespace resources{
    class Shader : public Resource{
        private:
            ...
            pu<std::string>  vertexShader_      = std::make_unique<std::string>("");
            pu<std::string>  geometryShader_    = std::make_unique<std::string>("");
            pu<std::string>  fragmentShader_    = std::make_unique<std::string>("");
